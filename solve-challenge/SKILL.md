...
If files are present locally, generate an intake report first:

```bash
python3 scripts/ctf_intake.py <challenge-dir-or-files> --description "<challenge text>"
```
...
Use the triage summary plus [shared/output-template.md](../shared/output-template.md) to hand off cleanly between categories instead of starting over from scratch.
